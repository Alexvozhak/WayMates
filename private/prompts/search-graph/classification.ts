...
import { DICTIONARY_LABELS } from "../../../src/facade/services/dictionaries.service.js";
import { getValidIntentsForPhase } from "../../../src/facade/langGraph/search-graph/search-router.js";
import { PHASE } from "../../../src/facade/langGraph/search-graph/state.js";

const DICTIONARY_TYPES_LIST = Object.keys(DICTIONARY_LABELS).join("/");

import type { RouteFlags } from "../../../src/facade/langGraph/search-graph/search-router.js";
import type { SearchPhase, SearchUserIntent } from "../../../src/facade/langGraph/search-graph/state.js";
