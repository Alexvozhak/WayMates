import { makeNullable, userContextSchemaBase } from "../../../../shared/schemas.js";
...
const adhocExtractionSchema = makeNullable(userContextSchemaBase);
const extractor = getModel("extraction").withStructuredOutput(adhocExtractionSchema);
...
async function extractAdhocContext(message: string): Promise<AdhocUserContext | null> {
  ...
  return hasAnyField ? extracted : null;
}
