...
import type { AdhocContextBase, ContextField, McpUpdateContextParams } from "@shared/schemas.js";
...
describe("Error Handling Integration Tests", () => {
  ...
  it("EH9: Concurrent operations - sessions isolated (no cross-talk)", async () => {
    ...
    const sessionId1 = await setupSession(u1.userId);
    const tool1 = new SearchCareersTool(deps);
